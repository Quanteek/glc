...
int main(int argc, char** tartanpion){
	...
	more_than_u more_than = more_than_u(std::atof(tartanpion[1]));
//    std::vector<double>::iterator it = std::find_if(v.begin(), v.end(), more_than_u(std::atof(tartanpion[1]))); 
